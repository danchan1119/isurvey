...
<cfcomponent displayName="Survey" hint="Handles all survey interactions." output="false">
	...
	<cffunction name="completeSurvey" access="public" returnType="void" output="false"
		...
		<cfif not surveyCompletedBy(arguments.id, arguments.ownerid)>
			...
			<cfquery datasource="#variables.dsn#">
				insert into #variables.tableprefix#survey_results(surveyidfk,ownerid,started,completed,ip,useragent)
				values(
				...
				<cfqueryparam value="#session.surveys[arguments.id].started#" cfsqltype="CF_SQL_TIMESTAMP" >,
				<cfqueryparam value="#now()#" cfsqltype="CF_SQL_TIMESTAMP" >,
				<cfqueryparam value="#CGI.REMOTE_ADDR#" cfsqltype="CF_SQL_VARCHAR" maxlength="35">,
				<cfqueryparam value="#CGI.HTTP_USER_AGENT#" cfsqltype="CF_SQL_LONGVARCHAR">
				)
			</cfquery>
