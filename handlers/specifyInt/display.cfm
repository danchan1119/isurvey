...
<cfif attributes.yesno>
		...
		<label for="question#attributes.step#_specify">
			...
			<input type="number" name="question#attributes.step#" id="question#attributes.step#_specify" value="#attributes.answer#" maxlength="255" onclick="form.question#attributes.step#_true.checked=true; validateInt#attributes.step#();">
				#answers["answer"][2]# &nbsp;&nbsp;
			<span class="textfieldRequiredMsg">#answers["answer"][3]#</span>
			<span class="textfieldMinValueMsg">#answers["answer"][3]#</span>
			<span class="textfieldMaxValueMsg">#answers["answer"][3]#</span>
  			<span class="textfieldInvalidFormatMsg">#answers["answer"][4]#</span></span>
		</label><br>
		<input type="radio" name="question#attributes.step#" id="question#attributes.step#_false" value="false" onclick="question#attributes.step#_specify.value=''; removeValidateInt#attributes.step#();" <cfif attributes.answer is "false">checked</cfif>><label for="question#attributes.step#_false">#answers["answer"][5]#</label><br>		
  </cfif>
</div>
<script type="text/javascript">
	//var sprytextfield#attributes.step# = new Spry.Widget.ValidationTextField("sprytextfield#attributes.step#", "integer", {allowNegative:false, minValue:"1", maxValue:"9999", validateOn:["change"]});
	
	if (document.getElementById("question#attributes.step#_true").checked){
          validateInt#attributes.step#();
	}
	else
	{
          removeValidateInt#attributes.step#();
	}
