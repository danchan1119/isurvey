...
<cfif attributes.yesno>
		...
		<cfelse>
		<input type="radio" name="question#attributes.step#" id="question#attributes.step#_true" value="0" onclick="question#attributes.step#_specify.value=''; removeValidateTxt#attributes.step#();" <cfif attributes.answer is "true">checked</cfif>><label for="question#attributes.step#_true">#answers["answer"][1]#</label>
		<label for="question#attributes.step#_specify"><br>
			<input type="radio" name="question#attributes.step#" id="question#attributes.step#_false" value="" <cfif len(attributes.answer)>checked</cfif>><span id="sprytextfield#attributes.step#">#answers["answer"][2]#
			<input type="text" name="question#attributes.step#" id="question#attributes.step#_specify" value="#attributes.answer#" maxlength="255" onclick="form.question#attributes.step#_false.checked=true; validateTxt#attributes.step#();">
				#answers["answer"][3]# &nbsp;&nbsp;
			<span class="textfieldRequiredMsg">#answers["answer"][4]#</span>
  			<span class="textfieldMaxCharsMsg">#answers["answer"][5]#</span></span>
		</label><br>
		<br>		
  </cfif>
</div>
<script type="text/javascript">
	...
	if (document.getElementById("question#attributes.step#_false").checked){
