...
<cfif attributes.yesno>
		<input type="radio" name="question#attributes.step#" id="question#attributes.step#_yes" value="yes" <cfif attributes.answer is "yes">checked</cfif>><label for="question#attributes.step#_yes"><cfif cgi.query_string eq 'id=41046F96-F857-E28A-1A253A7CD94741F1'>&##12399;&##12356;<cfelse>Yes</cfif></label><br>
		<input type="radio" name="question#attributes.step#" id="question#attributes.step#_no" value="no" <cfif attributes.answer is "no">checked</cfif>><label for="question#attributes.step#_no"><cfif cgi.query_string eq 'id=41046F96-F857-E28A-1A253A7CD94741F1'>&##12356;&##12356;&##12360;<cfelse>No</cfif></label><br>
		<cfelse>
