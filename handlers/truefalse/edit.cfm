	...
	<cfif not len(errors)>
		<cftry>
			<cfif not isDefined("attributes.question")>
				<cfset qid = application.question.addQuestion(question=form.question,rank=form.rank,required=form.required,surveyidfk=attributes.surveyidfk,questiontypeidfk=attributes.questionType.id,header=form.header)>
			<cfelse>
				<cfset application.question.updateQuestion(id=attributes.question.id,question=form.question,rank=form.rank,required=form.required,surveyidfk=attributes.surveyidfk,questiontypeidfk=attributes.questiontype.id,header=form.header)>
...
<table cellspacing=0 cellpadding=5 class="adminEditTable" width="100%">
	<tr valign="top">
		...
		<td><input class="span9" type="text" name="header" value="#form.header#" size="50"></td>
	</tr>
	<tr valign="top">
		<td><b>(*) Question:</b></td>
		<td><input class="span9" type="text" name="question" value="#form.question#" size="50"></td>
	</tr>
	<tr valign="top">
		<td><b>(*) Rank:</b></td>
